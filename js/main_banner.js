...
Carousel.prototype = {
  ...
  createDOM: function(container, options) {
    ...
    html = "<div class='carousel-box clearfix'>" +
      "<div class='transverse-box pull-left'></div>" +
  ...
  changeZindex_add: function() {
    ...
    $(".transverse-box").append("<div class='img-item' zindex='" + (parseInt(lastZindex) + 1) + "'><a href='" + firstImgUrl + "' target='_blank'><img src='" + firstImgSrc + "' alt='" + firstImgAlt + "' url='" + firstImgUrl + "'></a><div>");
  ...
  changeZindex_sub: function() {
    ...
    $(".transverse-box").prepend("<div class='img-item' zindex='" + (parseInt(firstZindex) - 1) + "'><a href='" + lastImgUrl + "' target='_blank'><img src='" + lastImgSrc + "' alt='" + lastImgAlt + "' url='" + lastImgUrl + "'></a><div>");
